...
class CompleteCollectionStats:
    ...
    def _graph(self, id, data, conf, ylabel="", tooltip_html=""):
        ...
        try:
            ...
            js_parts.append('        console.log("Card Evolution JS: Graph div not found, will retry");')
            js_parts.append('        return false;')
            js_parts.append('      }')
            js_parts.append('      ')
            ...
            js_parts.append('      ')
            js_parts.append('      console.log("Card Evolution JS: Graph rendered successfully on attempt " + attempts);')
            js_parts.append('      return true;')
            ...
            js_parts.append('      console.log("Card Evolution JS: Dependencies not ready, loading libraries (attempt " + attempts + ")");')
